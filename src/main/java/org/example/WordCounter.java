...
public class WordCounter {
    ...
    public static Map<String, Integer> calculatedWord() {
        ...
        // metni boşluklara göre bölerek dizi oluşturur
        String[] words = text.split("\\s+");

        for (String word : words) {
            // Küçük harfe dönüştürerek, kelimelerdeki büyük-küçük harf farkını göz ardı ediyoruz
            String lowercaseWord = word.toLowerCase();
            // Map'te kelimeyi kontrol edip, varsa sayısını artırıyoruz, yoksa yeni ekliyoruz
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> wordCountMap = calculatedWord();
